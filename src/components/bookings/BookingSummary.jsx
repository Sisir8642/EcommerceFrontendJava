...
const BookingSummary = ({booking, payment, isFormValid, onConfirm }) => {
  ...
  return (
    <div className='card card-body mt-5'>
      ...
      <p>chcek-In Date: <strong>{moment(booking.checkInDate).format("YYYY-MM-DD")}</strong></p>
      <p>chcek-Out Date: <strong>{moment(booking.checkOutDate).format("YYYY-MM-DD")}</strong></p>
      ...
      <div>
        ...
        <div>
          {payment() >0 ? (
            ...
            <p className='text-danger'> Check-out date must be after check-In date
